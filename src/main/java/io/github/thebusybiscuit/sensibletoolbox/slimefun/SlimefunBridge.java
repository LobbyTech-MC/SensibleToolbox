...
public final class SlimefunBridge implements SlimefunAddon {
    ...
    public SlimefunBridge(@Nonnull SensibleToolboxPlugin plugin) {
        ...
        ItemGroup items = new ItemGroup(new NamespacedKey(plugin, "items"), new CustomItemStack(Material.SHEARS, "&7STB - 物品"));
        ItemGroup blocks = new ItemGroup(new NamespacedKey(plugin, "blocks"), new CustomItemStack(Material.PURPLE_STAINED_GLASS, "&7STB - 机器"));
    ...
    public String getBugTrackerURL() {
        return "https://github.com/SlimefunGuguProject/SensibleToolboxReborn/issues";
    }
